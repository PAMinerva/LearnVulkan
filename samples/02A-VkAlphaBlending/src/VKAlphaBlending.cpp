...
#include "VKAlphaBlending.hpp"
#include "VKDebug.h"

#include "glm/gtc/matrix_transform.hpp"
#include "glm/ext/scalar_constants.hpp"

VKAlphaBlending::VKAlphaBlending(uint32_t width, uint32_t height, std::string name) :
...
m_dynamicUBOAlignment(0)
{
    ...
    glm::vec3 c_pos = { 0.0f, -15.0f, 5.0f };
...
VKAlphaBlending::~VKAlphaBlending()
{
    if (dynUBufVS.meshInfo)
        AlignedFree(dynUBufVS.meshInfo);
}

void VKAlphaBlending::OnInit()
{
    InitVulkan();
    SetupPipeline();
...
void VKAlphaBlending::InitVulkan()
{
    CreateInstance();
    CreateSurface();
...
void VKAlphaBlending::SetupPipeline()
{
    CreateVertexBuffer();
...
void VKAlphaBlending::OnUpdate()
{
    ...
    // Update dynamic buffer data (world matrices and colors).
    UpdateHostVisibleDynamicBufferData();
}

// Render the scene.
void VKAlphaBlending::OnRender()
{
...
void VKAlphaBlending::OnDestroy()
{
    m_initialized = false;
...
void VKAlphaBlending::CreateVertexBuffer()
{
...
void VKAlphaBlending::CreateHostVisibleBuffers()
{
    //
...
void VKAlphaBlending::CreateHostVisibleDynamicBuffers()
{
...
void VKAlphaBlending::UpdateHostVisibleBufferData()
{
...
void VKAlphaBlending::UpdateHostVisibleDynamicBufferData()
{
...
void VKAlphaBlending::CreateDescriptorPool()
{
    //
...
void VKAlphaBlending::CreateDescriptorSetLayout()
{
    //
...
void VKAlphaBlending::AllocateDescriptorSets()
{
...
void VKAlphaBlending::CreatePipelineLayout()
{
...
void VKAlphaBlending::CreatePipelineObjects()
{
    //
...
void VKAlphaBlending::PopulateCommandBuffer(uint32_t currentImageIndex)
{
...
void VKAlphaBlending::SubmitCommandBuffer()
{
...
void VKAlphaBlending::PresentImage(uint32_t currentImageIndex)
{
